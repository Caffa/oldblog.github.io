...
BLOG_AUTHOR = "Pamela Wang"  # (translatable)
BLOG_TITLE = "Pam Logs"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://Caffa.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://Caffa.github.io/"
BLOG_EMAIL = "wangyeelin@gmail.com"
BLOG_DESCRIPTION = "A blog to record interesting tidbits I have found, my projects or research into various topics. Mainly focusing on coding, productivity and health."  # (translatable)
